...
void setup() {
  ...
  Serial.begin(115200);
  konfigurasiWiFi("Gratis", "12341234");
}
...
void loop() {
  ...
  kirimKeAPI("https://simakaja.000webhostapp.com/sensor/api.php?nilaiNTU=" + String(nilaiNTU) + "&nilaiTDS=" + String(tdsValue) + "&nilaiPH=" + String(phValue) + "&nilaiFuzzy="  + String(fuzzyValue));
